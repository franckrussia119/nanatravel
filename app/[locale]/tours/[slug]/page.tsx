...
export default async function TourDetailPage({
  ...
  const t = await getServerTranslations(locale, "tourDetail");
  const common = await getServerTranslations(locale, "common");
  const tc = await getServerTranslations(locale, "tourCard");
          ...
          <div>
            ...
            {tour.gallery && tour.gallery.length > 0 && (
              <div className="mt-8 grid grid-cols-3 gap-3 sm:grid-cols-4">
                {tour.gallery.map((src: any, i: number) => (
            ...
            <div className="mt-10 grid gap-8 sm:grid-cols-2">
              <div>
                ...
                <ul className="mt-3 space-y-2">
                  {tour.included.map((item: any, i: number) => (
              ...
              <div>
                ...
                <ul className="mt-3 space-y-2">
                  {tour.notIncluded.map((item: any, i: number) => (
